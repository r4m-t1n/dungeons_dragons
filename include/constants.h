...
#define R_ROOM_5_NAME "Poisonous Bog"
#define R_ROOM_5_TYPE TRAP
#define R_ROOM_5_FATAL 0
#define R_ROOM_5_COINS 0

#define R_ROOM_6_NAME "Orc General"
#define R_ROOM_6_TYPE FIGHT
#define R_ROOM_6_FATAL 2
#define R_ROOM_6_DAMAGE 1
